...
1. **Found an Error?** 🐛 
   ...
   - Please report it by opening an [Issue](https://github.com/avionicscode/IGRSS/issues). Your feedback is critical to fixing bugs and improving the code.

2. **Suggestions for Improvements?** 🌟
   
   - Share your ideas and feature requests via an [Issue](https://github.com/avionicscode/IGRSS/issues) or a [Pull Request](https://github.com/avionicscode/IGRSS/pulls). 
...
**[Start Contributing Now!](https://github.com/avionicscode/IGRSS)** 🙌
